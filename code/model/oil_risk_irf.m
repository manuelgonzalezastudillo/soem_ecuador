...
titles = {'Oil Price','Gov Consumption','Gov Investment','Transfers',...
        ...
        'Optimizer Consumption','Restricted Consumption','Optimizer Hours','Restricted Hours'};
...
for ii = 1:length(all_vars)
    ...
    if any(strcmp(percent_dev,all_vars{ii})) 
        plot(1:20,100*round(eval(a)./abs(b),10), 'Color',colorscheme(kk,:),'Linewidth',2);hold on;         
    else
        plot(1:20,100*round(eval(a),10),'Color',colorscheme(kk,:),'Linewidth',2);hold on; 
    end 
