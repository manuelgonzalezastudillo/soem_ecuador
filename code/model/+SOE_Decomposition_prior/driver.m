...
options_ = [];
M_.fname = 'SOE_Decomposition_prior';
...
diary off;
diary('SOE_Decomposition_prior.log');
...
estim_params_.param_vals = [estim_params_.param_vals; 4, NaN, 0, Inf, 3, 2, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 1, NaN, NaN, NaN, 1, 0.8, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 2, NaN, 0, Inf, 3, 1, 10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 7, NaN, 0, Inf, 3, 1.5, .5, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 16, NaN, 0, Inf, 3, 6, 10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 11, NaN, 0, Inf, 3, 0.5, .5, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 10, NaN, NaN, NaN, 1, 0.3, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 41, NaN, (-Inf), Inf, 1, 0.75, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 42, NaN, (-Inf), Inf, 1, 0.75, 0.1, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 46, NaN, (-Inf), Inf, 1, 0.75, 0.1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 1, NaN, (-Inf), Inf, 4, .1, Inf, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 2, NaN, (-Inf), Inf, 4, .1, Inf, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 3, NaN, (-Inf), Inf, 4, .1, Inf, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 4, NaN, (-Inf), Inf, 4, .1, Inf, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 5, NaN, (-Inf), Inf, 4, .1, Inf, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 6, NaN, (-Inf), Inf, 4, .1, Inf, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 36, NaN, (-Inf), Inf, 1, 0.695335602121962, 0.15, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 11, NaN, (-Inf), Inf, 4, 0.0270415156952085, Inf, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 30, NaN, (-Inf), Inf, 3, 0.420787820063673, 7, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 31, (-0.052205750944297), (-Inf), 0, 3, (-0.052205750944297), 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 35, NaN, (-Inf), Inf, 1, 0.472291197161569, 0.25, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 12, NaN, (-Inf), Inf, 4, 0.153201302813339, Inf, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 27, NaN, (-Inf), Inf, 3, 3.373052046866841, 7, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 28, (-0.021234410874796), (-Inf), 0, 3, (-0.021234410874796), 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 37, NaN, (-Inf), Inf, 1, 0.380757720735125, 0.2, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 13, NaN, (-Inf), Inf, 4, 0.0998494301876969, Inf, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 33, NaN, (-Inf), Inf, 3, 5.603666220396844, 7, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 34, (-0.364600642998102), (-Inf), 0, 3, (-0.364600642998102), 1, NaN, NaN, NaN ];
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.1717;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.6137;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.5709;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 2.3985;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 1.4269;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.2177;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.1113;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.6809;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.7570;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.6477;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.7628;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.5729;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.5674;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.6501;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.5356;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = (-0.0559);
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.6691;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 1.5450;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = (-0.8963);
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.0462;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 3.4328;
end
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = (-0.0004);
end
...
if isempty(tmp1)
    ...
    estim_params_.var_exo(tmp1,2) = 0.0409;
end
...
if isempty(tmp1)
    ...
    estim_params_.var_exo(tmp1,2) = 0.0224;
end
...
if isempty(tmp1)
    ...
    estim_params_.var_exo(tmp1,2) = 0.0556;
end
...
if isempty(tmp1)
    ...
    estim_params_.var_exo(tmp1,2) = 0.0217;
end
...
if isempty(tmp1)
    ...
    estim_params_.var_exo(tmp1,2) = 0.0130;
end
...
if isempty(tmp1)
    ...
    estim_params_.var_exo(tmp1,2) = 0.0158;
end
...
if isempty(tmp1)
    ...
    estim_params_.var_exo(tmp1,2) = 0.1151;
end
...
if isempty(tmp1)
    ...
    estim_params_.var_exo(tmp1,2) = 0.2124;
end
skipline()
...
var_list_ = {'gam_YNCo_obs';'gam_C_obs';'gam_I_obs';'hours_obs';'xi_obs';'pCostar_obs';'YCo_obs';'gam_G_obs';'Rstar_obs';'Ystar_obs';'gam_Ig_obs';'gam_TR_obs';'ratio_TBY_obs';'gama_YNCo_obs'};
...
save('SOE_Decomposition_prior_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('SOE_Decomposition_prior_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('SOE_Decomposition_prior_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('SOE_Decomposition_prior_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('SOE_Decomposition_prior_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('SOE_Decomposition_prior_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('SOE_Decomposition_prior_results.mat', 'oo_recursive_', '-append');
end
